...
export default function DesktopHeader({ dict }: any) {
    ...
    return (
        <>
            ...
            <div className="w-full sticky top-0 flex items-center justify-between px-10 py-2">
                <div className="flex items-center gap-7">
                    <img src="/assets/logo.png" alt="Keita" className="h-7 w-auto relative bottom-[4px]" />
                </div>
                <div className="flex items-center gap-7">
            ...
            {extendedMenu != 'false' ? (
                <div className="absolute w-full px-10">
                    {extendedMenu == "courses" ? (
                        <div className="bg-neutral-50 shadow-md rounded-lg border border-1 border-neutral-200 min-h-64 ">

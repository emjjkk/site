...
export default async function Page({ params, }: { params: Promise<{ lang: any }> }) {
  ...
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section id="hero" className="bg-gradient-to-t from-gray-50 h-[145dvh] overflow-hidden border-b">
          <div className="h-[60dvh] flex flex-col items-center justify-center text-center mt-2">
            <h1 className="text-5xl/[1.2] font-bold mb-5">Gain Skills, Get Certified<br />On Africa's Leading EdTech Platform</h1>
            <p className="text-md mb-5 text-foreground/80 w-2/4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut maiores nulla sequi ducimus maxime voluptate, quas ea unde itaque ipsam magni adipisci repudiandae odit blanditiis, praesentium nesciunt doloribus, nemo expedita.</p>
        ...
        {/* Partners Section */}
        <section className="bg-white w-full py-6 gap-10 flex items-center justify-center border-b">
          <img src="https://upload.wikimedia.org/wikipedia/commons/1/1f/Alu_logo.png" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/University_of_Suffolk_Logo.png/1200px-University_of_Suffolk_Logo.png" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/MIT_logo.svg/2560px-MIT_logo.svg.png" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjm0-GZZjdfHQsEn9dw8ajQfJcvo_YwqjMtQ&s" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1200px-Google_2015_logo.svg.png" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/IBM_logo.svg/1075px-IBM_logo.svg.png" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRihVSvF9oqeR6OrMlmUiF07pjpZ-3mutphQw&s" alt="" className="h-6 grayscale-100 hover:grayscale-0" />
        </section>
        ...
        <section className="w-full min-h-[80dvh] bg-white py-20 border-b">
          <div className="mx-auto px-15">
            <div className="grid grid-cols-2 gap-16 items-center mb-16">
              <div>
                <h2 className="text-4xl font-bold mb-6">Built for African Students</h2>
                <p className="text-lg text-foreground/80 mb-8">Experience learning designed specifically for the African context, with local case studies, flexible scheduling, and affordable pricing.</p>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-center mb-8">There's a Program for Everyone</h3>

              <div className="grid grid-cols-3 gap-8">
                <div className="bg-gray-50 border p-8 text-center">
                  <h4 className="text-xl font-semibold mb-4">Short Courses</h4>
                ...
                <div className="bg-gray-50 border p-8 text-center">
                  <h4 className="text-xl font-semibold mb-4">Professional Qualifications</h4>
                ...
                <div className="bg-gray-50 border p-8 text-center">
                  <h4 className="text-xl font-semibold mb-4">Full Degrees</h4>
        ...
        {/* For Educators Section */}
        <section className="w-full min-h-[80dvh] bg-gray-50 py-20 border-b">
          <div className="mx-auto px-15">
            <div className="grid grid-cols-2 gap-16 items-center">
              <div className="bg-gray-200 h-96"></div>

              <div>
                <h2 className="text-4xl font-bold mb-6">Empower Your Institution</h2>

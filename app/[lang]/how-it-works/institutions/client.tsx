            ...
            <main className="min-h-screen">
                <div className="w-full bg-neutral-50 ">
                    <div className="h-full px-4 md:px-12 py-6 flex flex-col">
                        <p className="text-sm text-neutral-500 mb-3">Home / How It Works / For Institutions</p>
                        <h1 className="text-4xl font-bold font-mono">For Institutions</h1>
                        <p className="md:w-2/4 text-lg text-neutral-600">Connect your institution with learners worldwide.</p>
